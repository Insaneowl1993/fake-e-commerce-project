[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=13292748&assignment_repo_type=AssignmentRepo)
<br/>
<br/>
...
## Create Fake E Commerce Website

Create a fake eCommerce website with the data from the [FakeStore API](https://fakestoreapi.com/products/).
...
- Create drop down selection to choose individual product categories
  ...
  - (Optional extra 3) Create EChart on separate page to display average item price from each category
